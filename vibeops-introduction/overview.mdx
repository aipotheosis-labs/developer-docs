...
<Steps>
  <Step title="Visit VibeOps Platform">
    Navigate to [VibeOps <Icon icon="up-right-from-square"/>](https://vibeops.aci.dev/) and sign in with your Google account.
     <Frame>
      <img src="/images/vibeops/google-sign-in.png" alt="MCP feature enabled for seamless development" />
    </Frame>
  ...
  <Step title="Install Cursor">
    If you don't have Cursor installed yet, download and install it from [cursor.com](https://cursor.com/).
...
<Frame>
  <img src="/images/vibeops/project-page.png" alt="VibeOps project page showing reset button" />
</Frame>
