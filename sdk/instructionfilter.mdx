...
Before a function is executed in our *Unified Function Calling Handler* we check if the function arguments violate the instruction filter and whether the function should be executed.
