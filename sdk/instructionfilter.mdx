...
Before a function is executed in our *Unified Function Calling Handler* we check whether the function arguments violate the instruction filter and whether the function should be executed.
