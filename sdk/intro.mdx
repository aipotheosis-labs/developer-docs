...
icon: 'code'
---
The Aipolabs ACI [Python SDK](https://github.com/aipotheosis-labs/aci-python-sdk) offers a convenient way to access the Aipolabs ACI REST API from any Python 3.10+ application.
...
<Note>
For complete and up-to-date documentation, please check out the [SDK repository](https://github.com/aipotheosis-labs/aci-python-sdk).
</Note>
## Client
```
